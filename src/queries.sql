...
SELECT t.tx_id,t.user_id,t.date,t.region,t.merchant,t.amount,us.tx_count,us.avg_amount,us.total_amount,COALESCE(du.daily_tx,0) daily_tx,COALESCE(du.daily_amount,0.0) daily_amount,t.label
FROM transactions t
